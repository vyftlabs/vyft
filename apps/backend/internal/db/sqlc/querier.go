...
type Querier interface {
	...
	DeleteProvisionedSourcesNotIn(ctx context.Context, dollar_1 []string) error
	...
	UpdateDeploymentSnapshot(ctx context.Context, arg UpdateDeploymentSnapshotParams) error
	...
	UpsertProvisionedSource(ctx context.Context, arg UpsertProvisionedSourceParams) (Source, error)
}
