...
import { collect, deploy } from "../../src/engine/index.ts";
import type { DockerClient } from "../../src/runtimes/docker/client.ts";
import { createDockerClient } from "../../src/runtimes/docker/client.ts";
import { createRuntime } from "../../src/runtimes/index.ts";
import type { K8sClient } from "../../src/runtimes/k8s/client.ts";
import { loadK8sClient } from "../../src/runtimes/k8s/client.ts";
...
async function k8sAvailable(): Promise<boolean> {
  try {
    ...
    await client.core.listNamespace();
    return true;
  } catch {
    return false;
  }
